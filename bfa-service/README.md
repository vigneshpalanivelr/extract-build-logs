...
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:vector_db:[VectorDB] init_vector_db() -> /var/lib/redis/bfa-data
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:     Started server process [661969]
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:     Waiting for application startup.
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:analyzer:[RAG] Loaded domain context from /home/build-failure-analyzer/build-failure-analyzer/context/d>
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:vector_db:[VectorDB] Connected to Chroma collection 'fix_embeddings' (path=/var/lib/redis/bfa-data)
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:pipeline_context_rag:[RAG] Initialized domain context collection 'pipeline_context' at /var/lib/redis/b>
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:analyzer:[RAG] Domain context collection already has 75 vectors, skipping index
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:analyzer:[RAG] Domain context RAG initialized successfully
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:     Application startup complete.
Jan 16 09:10:05 slack-server-1 uvicorn[661969]: INFO:     Uvicorn running on http://0.0.0.0:8000 (Press CTRL+C to quit)
```
